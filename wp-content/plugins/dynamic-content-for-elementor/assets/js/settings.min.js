...
return ret}
dynamicooo.makeSwiperBreakpoints=(swiperSettings,elementorSettings,prefix='')=>{const elementorBreakpoints=dynamicooo.getActiveBreakpointsMinPointAndPostfix();const breakpoints={};const lastBreakpointValues={};Object.keys(elementorBreakpoints).reverse().forEach((breakpointName)=>{let min_point=elementorBreakpoints[breakpointName].min_point;if(elementorBreakpoints[breakpointName].postfix==='_mobile'){min_point=0}
