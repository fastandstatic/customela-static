...
! function ($, options) {
    ...
    var Utils = function (options) {
        ...
        return {
            ...
            loadGTMScript: function (id) {
                ...
                const datalayer_name = options.gtm.gtm_dataLayer_name ?? 'dataLayerPYS';
                ...
                if ( options.google_consent_mode ) {
                    ...
                    this.dataLayerName = datalayer_name;
                    this.loadDefaultConsent( 'consent', 'default', data );
                }
            },
    ...
    var GTM = function (options) {
        ...
        var datalayer_name = 'dataLayerPYS';
        /*
         * @param name
         * @param data
         */
        function fireEvent(name, event) {
            ...
            var _fireEvent = function (tracking_id,name,params) {
                ...
                if (options.debug) {
                    var displayName = name.replace(/^CE_/, '');
                    if (options.gtm.container_code){
                        console.log('[Google GTM #' + tracking_id + '] ' + displayName, params);
                    }
                    else {
                        console.log('[Google GTM push to "'+datalayer_name+'"] ' + displayName, params);
                    }
                }
                if (params.hasOwnProperty('customParameters')) {
                    var customParameters = params.customParameters;
                    delete params.customParameters;
                    window[datalayer_name].push({'event': name, 'eventModel': params, 'customParameters': customParameters});
                } else {
                    window[datalayer_name].push({'event': name, 'eventModel': params});
                }
        ...
        return {
            ...
            loadPixel: function () {
                ...
                datalayer_name = options.gtm.gtm_dataLayer_name ?? 'dataLayerPYS';

                for (var i = 0; i < options.gtm.trackingIds.length; i++) {
                    var trackingId = options.gtm.trackingIds[i];
                    if (!Utils.hideMatchingPixel(trackingId, 'gtm') && options.gtm.container_code) {
